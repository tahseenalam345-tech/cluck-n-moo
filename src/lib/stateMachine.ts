...
const ALLOWED_TRANSITIONS: Record<OrderStatus, OrderStatus[]> = {
  [ORDER_STATUSES.NEW]: [ORDER_STATUSES.CONFIRMED, ORDER_STATUSES.PREPARING, ORDER_STATUSES.CANCELLED],
...
export function validateStatusTransition(
  ...
  if (role === "KITCHEN_STAFF") {
    if (
      ...
      (currentStatus === ORDER_STATUSES.NEW && targetStatus === ORDER_STATUSES.PREPARING) ||
